...
for _ in range(globalParameters.extra_cars):
    ...
    car = new Car on random_pos, with behavior DriveAvoidingCollisions(target_speed=random_speed, avoidance_threshold=12)
