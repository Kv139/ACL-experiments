...
param cone_lane = VerifaiOptions([*network.lanes])
...
cone_start = Uniform(*globalParameters.cone_lane.centerline.points)
cone_pos = (cone_start[0] @ cone_start[1])
cone_pos2 = (cone_start[1] @ cone_start[0])
...
obstacle = new Car at cone_pos, facing cardegree relative to roadDirection, with allowCollisions True
obstacle2 = new Car at cone_pos, facing cardegree relative to roadDirection, with allowCollisions True
